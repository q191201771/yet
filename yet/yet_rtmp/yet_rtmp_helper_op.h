...
struct RtmpUrlStuff {
  ...
  std::string stream_name_with_full_param;
};

class RtmpHelperOp {
  public:
    // rtmp://host:port/app_name/stream_name?a=1&b=2
    // origin_url -> rtmp://host:port/app_name/stream_name?a=1&b=2
    ...
    // stream_name_with_full_param -> stream_name?a=1&b=2
